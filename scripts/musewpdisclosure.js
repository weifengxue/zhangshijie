...
(function (a, b, c) {
    c.Plugins.TabbedPanelsPlugin = {
        ...
        initialize: function (c, f) {
            var g = this;
            a.extend(f, a.extend({}, g.defaultOptions, f));
    ...
    c.Plugins.AccordionPlugin = {
        ...
        initialize: function (c, f) {
            var g = this;
            a.extend(f, a.extend({}, g.defaultOptions, f));
            f.toggleStateEnabled = f.canCloseAll;
            b.Widget.Disclosure.AccordionTransitionPlugin.initialize(c, f);
            c.bind("transform-markup", function () {
                g._transformMarkup(c)
            });
            c.bind("attach-behavior", function () {
                g._attachBehavior(c)
            })
        ...
        _transformMarkup: function (c) {
            var f = c.$element[0],
                c =
                c.options,
                g = c.transitionDirection === "vertical";
            b.scopedFind(f, ".AccordionPanelContent", c.widgetClassName, f).each(function () {
                var b = a(this),
                    c = !g ? parseInt(b.css("left")) : 0;
                b.removeClass(g ? "AccordionPanelContent colelem" : "AccordionPanelContent grpelem").wrap(g ? '<div class="AccordionPanelContent colelem"><div class="AccordionPanelContentClip"></div></div>' : '<div class="AccordionPanelContent grpelem"><div class="AccordionPanelContentClip"></div></div>').closest(".AccordionPanelContent").css({
                    width: "100%",
                    height: "100%",
                    position: "relative",
                    left: c + "px"
        ...
        _attachBehavior: function (c) {
            var f = c.$element[0],
                g = c.options,
                k = 0,
                h = g.transitionDirection === "vertical",
                j = h ? "offsetWidth" : "offsetHeight",
                i = h ? "width" : "height",
                l = 0;
            b.scopedFind(f, ".AccordionPanel", g.widgetClassName, f).each(function () {
                k = k < this[j] ? this[j] : k
            }).each(function () {
                k > this[j] && (this.style[i] = k + "px");
                if (!h) {
                    var b = a(this);
                    b.css({
                        width: "auto",
                    ...
                    l += b.children("." + g.tabClassName).outerWidth()
                }
            })
        }
    };
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.0.2.310" != d.getAttribute("content") && Muse.assets.outOfDate.push("musewpdisclosure.js");
                    break
                }
            }
        }
